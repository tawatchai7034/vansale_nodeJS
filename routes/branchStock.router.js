...
branchStockRouter.post("/getSPOrderDT", async (req, res) => {
  try {
    ...
    const result = await client.query(
      `SELECT PDT."cGUID",PDT."cPOCD",PDT."iSEQ",PDT."cPRODCD",PDT."cPRODNM",
      PDT."iSSTOCK",PDT."iMSTOCK",PDT."iLSTOCK",PDT."cSUOMCD",PDT."cSUOMNM",
      PDT."cMUOMCD",PDT."cMUOMNM",PDT."cLUOMCD",PDT."cLUOMNM",PDT."iMARKET",
      PDT."iPLUSQTY",PDT."iENOUGHQTY",PDT."iTOTAL",PDT."iPURCHASE",PDT."iLUNITPRICE",
      PDT."iNETPRICE",PDT."cMONQTY",PDT."cTUEQTY",PDT."cWEDQTY",PDT."cTHUQTY",
      PDT."cFRIQTY",PDT."cSATQTY",PDT."cSUNQTY",PDT."cSTATUS",PDT."dCREADT",
      PDT."cCREABY",PDT."dUPDADT",PDT."cUPDABY",PDT."cREFENOUGH",PR."cPHOTO_SERV",
      PR."cPHOTO_PATH",PR."cPHOTO_NM",PR."cBASKCD",BK."cBASKNM",BK."iPRICE",PR."cTYPE",PTY."cTYPENM",
      PR."cCATECD",PCG."cCATENM",PR."cSUBCATECD",PSC."cSUBCATENM",PR."cBRNDCD",BND."cBRNNM" 
